qx.Class.define ( "venditabant.settings.views.Accounts",
    {
            ...
            members: {
                    // Public functions ...
                    getView: function () {
                        let box1 = new qx.ui.groupbox.GroupBox(this.tr("Accounts"), null);
                        ...
                        let invoicedays_txt = this._createTxt(
                            this.tr( "Accounts" ),100,true,this.tr("Account is required")
                        );
