...
qx.Class.define ( "venditabant.support.views.MailSettings",
    {
            ...
            loadSmtpSettings:function() {
                ...
                model.load(function(response) {
                    if(typeof response.data !== 'undefined' && response.data !== null ) {
                        that._host.setValue(response.data.value.host);
                        that._port.setValue(response.data.value.port);
                        that._ssl.setValue(response.data.value.ssl);
                        that._sasl_username.setValue(response.data.value.sasl_username);
                        that._sasl_password.setValue(response.data.value.sasl_password);
                    }
                },this, 'SMTP');
            },
