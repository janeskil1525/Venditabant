qx.Class.define ( "venditabant.settings.views.ProdGrpBox",
    {
            ...
            members: {
                    // Public functions ...
                    getView: function () {
                        let box1 = new qx.ui.groupbox.GroupBox(this.tr("Product groups"), null);
                        box1.setLayout(new qx.ui.layout.VBox());
                        let container = new qx.ui.container.Composite(new qx.ui.layout.HBox(6));

                        let lbl = this._createLbl(this.tr( "Product group" ),90);
                        let prdgrp_txt = this._createTxt(
                            this.tr( "Product group" ),100,true,this.tr("Product group is required")
                        );
