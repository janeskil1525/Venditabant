...
qx.Class.define("venditabant.sales.customers.views.CustomersSelectBox",
    {
        ...
        members: {
            ...
            getView: function () {
                ...
                new venditabant.sales.customers.helpers.CustomerList().set({
                    list: selectbox,
            ...
            getKey:function() {
                if(this._model.getModel() === null) {
                    ...
                    return this._model.getModel().customers_pkey ? this._model.getModel().customers_pkey : 0;
                }
            },
